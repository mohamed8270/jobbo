...
import { extractJobviewsAverage } from '@/lib/utils/jobs_analytics';
    ...
    <div className='h-screen bg-jbgrey pt-[80px] pl-[40px] pr-[40px] min-h-screen'>
      <div className='py-[40px]'>
        <div className='flex justify-between items-center'>
          <JobsAnalyticsCard href='/' icn='https://www.svgrepo.com/show/509920/eye.svg' txt1='Most viewed' txt2={extractJobviewsAverage(jobsdata)} percentage='3.8%' />
